  ...
  render() {
    return (
      <Container title={BRAND_TITLE}>
        <Badges />
        <p>
          Include popular icons in your Vue projects easily with vue3-icons, which utilizes ES6
        ...
        <CodeBlock language="bash" code={`npm install vue3-icons --save`} />
        ...
        <CodeBlock language="bash" code={`npm install @vue3-icons/all-files --save`} />
        ...
        <h2>More info</h2>
        <p>
          <a href="https://github.com/vue-icons/vue-icons">GitHub &#8599;</a>
        </p>
      </Container>
    )
  }
